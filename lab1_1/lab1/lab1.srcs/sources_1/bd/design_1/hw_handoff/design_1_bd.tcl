...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FIR_OUT_0 [ create_bd_port -dir O -from 15 -to 0 FIR_OUT_0 ]
  set RSTn_0 [ create_bd_port -dir I -type rst RSTn_0 ]
  set aclk_0 [ create_bd_port -dir I -type clk aclk_0 ]

  # Create instance: FIR_0, and set properties
  set block_name FIR
  set block_cell_name FIR_0
  if { [catch {set FIR_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  connect_bd_net -net FIR_0_FIR_OUT [get_bd_ports FIR_OUT_0] [get_bd_pins FIR_0/FIR_OUT]
  connect_bd_net -net RSTn_0_1 [get_bd_ports RSTn_0] [get_bd_pins FIR_0/RSTn]
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins FIR_0/CLK] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins mult_gen_0/CLK]
  ...
  connect_bd_net -net mult_gen_0_P [get_bd_pins FIR_0/FIR_IN] [get_bd_pins mult_gen_0/P]
