...
HD_PWD='D:/ipsetADC/ipsetADC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_ADC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_ADC.tcl
